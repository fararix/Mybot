...
# ================= CONFIG =================
API_ID = 33234181
API_HASH = 'f420c93bd98d7f24eaadf649b1357951'
BOT_TOKEN = '8159434112:AAHM5YotGvlOzcXCdg-coDAJcl2V9sq7h58'
...
async def main_menu_keyboard():
    return [
        [Button.inline("Add Admin", b"btn_add_admin_menu"), Button.inline("Remove Admin", b"btn_del_admin_select_g")],
...
async def callback_handler(event):
    ...
    if cmd == "btn_add_admin_menu":
        ...
        btns.append([Button.inline("Back", b"main_menu")])
        if not btns: await event.answer("No admins found.", alert=True)
        ...
        btns.append([Button.inline("Back", b"main_menu")])
        if not btns: await event.answer("List is empty.", alert=True)
        else: await event.edit("Select Group:", buttons=btns)
